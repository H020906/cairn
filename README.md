...
| Workload SDK | Not started |
| Dashboard + live globe | Not started |
| A real scientific workload (molecular docking) | Not started — but the transcendental functions it needs now exist, and so does dynamic dispatch |
